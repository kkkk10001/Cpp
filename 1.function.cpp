...
// 선언한 아래의 이 모든 부분에서 공유해서 사용이 가능하다.
...
반환타입 : 이 함수가 기능을 수행하고 기능을 결과를 반환해야할 경우 지정한다.
...
인자 : 해당 함수를 사용할때 넘겨줄 값이 있을경우 인자를 활용한다. 인자느 있을수도
있고 없을수도 있다.
...
// 속해있다고 판단한다. 즉, 이 함수의 지역변수가 되고 stack에 할당 된다.
...
// 아래 함수는 결과 값을 인자로 받아와서 결과를 반환해주었다. 이런 형태의 함수를
